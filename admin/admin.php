...
<head>
    ...
    <style>
        /* Tạo khoảng trống phía dưới để tránh footer fixed-bottom che khuất */
        .content {
            padding-bottom: 80px; /* tuỳ chỉnh nếu cần */
        }
        /* Chỉ cuộn riêng phần bảng */
        .scrollable-table {
            max-height: 400px; /* Chiều cao tối đa khi cuộn */
            overflow-y: auto;
        }
    </style>
</head>
                    ...
                    <div class="collapse navbar-collapse" id="navbarNav">
                        <ul class="navbar-nav ms-auto">
                            ...
                            <li class="nav-item d-flex align-items-center" id="logout-link" <?php if (!isset($_SESSION['user_id'])) echo 'style="display:none;"'; ?>>
                                <span class="nav-link me-2 text-white" id="username-display">
                                    <?php echo isset($_SESSION['username']) ? "Logged in as: " . htmlspecialchars($_SESSION['username']) : ''; ?>
                                </span>
                                <a class="nav-link btn btn-sm" href="admin_logout.php" id="logout-button"
                                   onclick="return confirm('Bạn có chắc chắn muốn đăng xuất không?');">Logout</a>
                            </li>
                        </ul>
                    </div>
                </div>
                ...
                <div class="tab-content" id="myTabContent">
                    ...
                    <div class="tab-pane fade show active" id="users" role="tabpanel" aria-labelledby="users-tab">
                        ...
                        <div class="d-flex justify-content-between align-items-center mb-3">
                            ...
                            <select id="userLimit" class="form-select w-auto">
                        ...
                        <!-- Bọc danh sách user vào div có scroll -->
